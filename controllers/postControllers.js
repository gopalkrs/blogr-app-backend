import addPostComment from "../actions/post-actions/addPostComment.js";
...
import getCommentsByPostId from "../actions/post-actions/getCommentsByPostId.js";
import getLikedPostById from "../actions/post-actions/getLikedPostById.js";
...
import updateLikesPost from "../actions/post-actions/updateLikesPost.js";
...
const likePostController = (req, res) => {
  return updateLikesPost(req, res);
};

const likedPostByIdController = (req, res) => {
  return getLikedPostById(req, res);
};

const getPostCommentsController = (req, res) => {
    return getCommentsByPostId(req, res);
}

const commentPostController = (req, res) => {
    return addPostComment(req, res);
}

export {
  createPostController,
  getMostRecentPostsController,
  getPostsController,
  ...
  getMostLikedPostsController,
  likePostController,
  likedPostByIdController,
